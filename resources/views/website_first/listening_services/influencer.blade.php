...
<div class="contain">
    ...
    <div class="sec-2">
        <div class="sec2-content">
            ...
            <div class="rl" style="position: relative;">
                ...
                <div class="rl-cards" style="position: absolute; top: 0; width: 100%;">
    ...
    <div class="compatitve">
        ...
        <p>We equip your business with key influencers to leverage their networks and trust to achieve marketing
            success.</p>
        <div class="compatitve-content influencer-content ">
            <img src="{{asset('website/assets/imgs/img25.png')}}" alt="" loading="lazy" />
