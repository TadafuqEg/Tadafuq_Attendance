...
<div class="contain">
    ...
    <div class="sec-2">
        <div class="sec2-content">
            <h5 class="h-5 plus">Why Authenticity Analysis, Fact<br /> Checking & Bots Detection are
                <br />Important?
            </h5>
    ...
    <div class="compatitve">
        ...
        <div class="compatitve-content authenticity-content">
            <img src="{{asset('website/assets/imgs/img26.png')}}" alt="">
